...
<body>
<h2 align="center" style="color: #8d2c31;">For the Cracker we have</h2>
            ...
            <?php foreach ($product as $product): ?>
                <figure data=<?= $product->Product_ID?> style="width:460px">
                    ...
                    <figcaption>
                        ...
                        <button class="button"> <?= $this->Form->postLink(__('Add to Cart'), ['controller'=>'Carts','action' => 'add', $product->Product_ID]) ?></button>
