    ...
    public function add()
    {
        ...
        if ($this->request->is('post')) {
            ...
            if ($this->Staff->save($staff)) {
                $this->Flash->success(__('The wholesale enquire has been sent.'));

                return $this->redirect(['controller'=>'Staff','action'=>'add']);
            }
            $this->Flash->error(__('The wholesale enquire could not be saved. Please, try again.'));
        }
        $this->set(compact('staff'));
    }
